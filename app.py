...
def render_resume(id):
    return render_template(f'resume{id}.html')



@app.route('/resume1.html')
def use_template():
    ...
    return render_template('resume1.html', name=name, file=file, resumes=resumes)
